...
var month = parseInt(prompt("Enter a Month in Numeric Form (1-12) here: "));
...
{
    var hone = document.getElementById("WarningTxt");
    var honeTextNode = document.createTextNode("Invalid Entries");
